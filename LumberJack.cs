...
public class LumberJack : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (LumberJackMenu.activeSelf == true && isMenuOpen == true)
        {
            canMove = false;
            canRotate = true;
            if (canRandomize)
            {
                ...
                if (message == 1)
                    LumberJackMenu.GetComponentInChildren<TextMeshProUGUI>().text = texts[0];
                if (message == 2)
                    LumberJackMenu.GetComponentInChildren<TextMeshProUGUI>().text = texts[1];
                if (message == 3)
                    LumberJackMenu.GetComponentInChildren<TextMeshProUGUI>().text = texts[2];
            }
            canRandomize = false;
            if (canRotate)
            {
