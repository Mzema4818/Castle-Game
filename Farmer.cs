...
public class Farmer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (farmerMenu.activeSelf == true && isMenuOpen == true)
        {
            canMove = false;
            canRotate = true;
            if (canRandomize)
            {
                ...
                if (message == 1)
                    farmerMenu.GetComponentInChildren<TextMeshProUGUI>().text = texts[0];
                if (message == 2)
                    farmerMenu.GetComponentInChildren<TextMeshProUGUI>().text = texts[1];
                if (message == 3)
                    farmerMenu.GetComponentInChildren<TextMeshProUGUI>().text = texts[2];
            }
            canRandomize = false;
            if (canRotate)
            {
