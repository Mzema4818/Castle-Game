...
public class DayNightCycle : MonoBehaviour
{
    ...
    private Color lerpedColor2;
    private Color lerpedColor3;
    private Color lerpedColor4;
    ...
    private void Update()
    {
        if (!pause)
        {
            ...
            if (grassObject != null)
            {
                ...
                //print(grassObject.GetComponent<Renderer>().sharedMaterial.GetColor("_BottomColor"));
            }
        }
    ...
    private void UpdateTime()
    {
        ...
        duration += Time.deltaTime * _timeScale / 86400;
